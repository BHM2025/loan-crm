      ...
      <header style={{ backgroundColor: "rgba(255,255,255,0.15)", backdropFilter: "blur(8px)", borderBottom: "1px solid rgba(255,255,255,0.2)", position: "sticky", top: 0, zIndex: 10 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <Link href="/analytics" style={{ background: "#ecfdf5", border: "1px solid #a7f3d0", borderRadius: 20, padding: "6px 14px", fontSize: 12, color: "#065f46", fontWeight: 600, textDecoration: "none" }}>
              📊 Analytics
            </Link>
