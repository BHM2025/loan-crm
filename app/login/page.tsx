...
function LoginForm() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(rgba(255,255,255,0.15), rgba(255,255,255,0.15)), url('/bg.png') center/cover no-repeat fixed", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui, sans-serif" }}>
