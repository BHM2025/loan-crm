...
function LoginForm() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0a2463 0%, #1565c0 60%, #1a237e 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui, sans-serif" }}>
